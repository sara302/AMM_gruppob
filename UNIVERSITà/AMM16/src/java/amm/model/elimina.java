 ...
 * @author ASSO
 */
@WebServlet(name = "elimina", urlPatterns = {"/elimina_oggetto.html"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         if(request.getParameter("Elimina") == null){
            ...
            request.getRequestDispatcher("elimina_oggetto.jsp").forward(request, response);
        }
        
      else  if(request.getParameter("Elimina") != null){
            int id = Integer.parseInt(request.getParameter("id"));
       
            Cofanetti_Factory.getInstance().elimina(id); 
