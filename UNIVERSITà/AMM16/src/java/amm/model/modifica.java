 ...
 * @author ASSO
 */
@WebServlet(name = "modifica", urlPatterns = {"/modifica_oggetto.html"})
public class modifica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("Modifica") == null){
            ...
            request.getRequestDispatcher("modifica_oggetto.jsp").forward(request, response);
        }
           ...
           cofanetti oggetto = Cofanetti_Factory.getInstance().modifica(id, titolo, stagione, genere, imm, trama, prezzo, quantita);
